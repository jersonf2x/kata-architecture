...
| Resiliencia | Aislamiento de fallas y recuperacion automatica ante terceros inestables | Circuit breaker, bulkhead, timeouts, retries idempotentes, colas de reintento | Fallo en fraude no afecta pagos | Blast radius por fallo, tiempo de recuperacion |
| Eliminacion batch nocturno | Procesamiento continuo sin ventanas operativas bloqueantes | CQRS, Event Streaming, proyecciones incrementales, reconciliacion continua | Operacion 24/7 sin ventanas | Horas de indisponibilidad por mantenimiento |
